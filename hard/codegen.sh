...
# Go code-gen
protoc --proto_path=./proto/ proto/ones.proto --go_out=plugins=grpc:go/services
protoc --proto_path=./proto/ proto/twos.proto --go_out=plugins=grpc:go/services
protoc --proto_path=./proto/ proto/threes.proto --go_out=plugins=grpc:go/services
